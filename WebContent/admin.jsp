        		...
        		for(int i=0;i<array.length();i++)
               	{
        			data=(JSONObject)array.get(i);
        					clinic_id=data.get("clinic_id").toString();
        					patient_name=data.get("patient_name").toString();
        					patient_id=data.get("patient_id").toString();
        					sex=data.get("sex").toString();
        					age=data.get("age").toString();
        					jio_id=data.get("jio_id").toString();
        					contact_number=data.get("contact_number").toString();
        					link=data.get("linkdownload").toString();
        					datetime=data.get("ecgtest_date").toString();
